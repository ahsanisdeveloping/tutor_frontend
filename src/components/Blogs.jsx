    ...
    <div className="px-2 sm:px-20 py-10 font-montserrat">
      <div className="bg-[#DBCFBC] rounded-3xl p-8 shadow-lg flex flex-col lg:flex-row gap-8 ">
        <div className="flex-1">
          ...
          <h3 className="text-xl sm:text-[34px] font-semibold text-[#074226] mb-4 sm:leading-relaxed font-montserrat">
            How to Study efficiently? A complete Guide to get good grades
          </h3>
          <p className="text-gray-600 mb-6 sm:text-[18px] sm:leading-relaxed font-montserrat">
          ...
          <div className="flex items-center gap-4 mb-6">
            <span className="flex p-2 bg-[#FFFFFF8A] rounded-xl gap-1 text-sm sm:text-md font-montserrat">
              {" "}
              <svg
            ...
            <span className="flex p-2 bg-[#FFFFFF8A] rounded-xl gap-1 font-montserrat">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
          ...
          <button className="btn bg-[#074226] text-white text-[16px] font-montserrat">
            Read More →
          </button>
        </div>
      ...
      <div className="p-6">
        <h2 className="text-2xl sm:text-[53px] font-semibold mb-6 text-center py-5 sm:py-10 font-montserrat">
          Trending Blogs
        </h2>
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 p-3  sm:p-6 bg-base-200 rounded-lg shadow-lg">
        <div className="flex-1">
          <h2 className="text-2xl sm:text-[39px] font-semibold mb-4 text-[#074226] font-montserrat">
            The Ultimate Guide to Studying Effectively for Top Grades
          </h2>
          <p className="text-black text-lg  sm:text-[24px] mb-6 font-montserrat">
          ...
          <button className="btn bg-[#074226] text-[16px] text-white font-montserrat">
            Read More →
          </button>
        </div>
        <div className="flex-none w-full lg:w-1/3">
