  ...
  return (
    <div className="bg-white px-6 lg:px-5 py-10">
      ...
      <div className="text-center py-6">
        <h1 className="mx-auto sm:w-[900px] leading-normal text-3xl md:text-5xl lg:text-[53px] font-[500] mb-10 font-clash">
      ...
      <div className="flex flex-col md:flex-row items-center bg-[#074226] text-white py-10 px-3 md:px-10 lg:px-10 sm:gap-14 rounded-lg mt-5 sm:mt-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left ">
          <h2 className="text-2xl md:text-[42px] font-[500] leading-tight font-clash">
